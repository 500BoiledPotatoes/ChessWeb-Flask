...
from blogapp.forms import LoginForm, SignupForm, ProfileForm,PostForm,JoinForm,ChessForm
from blogapp.models import User,Post,Profile,Games
		...
		if form.validate_on_submit():
			...
			if game_in_db:
				...
				if(game_in_db.player==user_in_db.id):
					return render_template('game.html',g=g,form=form,player='1')
				else:
					return 'Not your turn'
			if game_in_db2:
				g=game_in_db2.game
				if(game_in_db2.player==user_in_db.id):
					return render_template('game.html',g=g,form=form,player='2')
				else:
					return 'Not your turn'
			else:
